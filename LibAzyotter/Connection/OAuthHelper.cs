...
namespace LibAzyotter.Connection
{
    public static class OAuthHelper
    {
        ...
        {
            return new Uri(url).GetComponents(UriComponents.Scheme | UriComponents.UserInfo | UriComponents.Host | UriComponents.Port | UriComponents.Path, UriFormat.UriEscaped);
        }
        ...
        public static string Signature(string baseString, string consumerSecret, string tokenSecret)
        {
            ...
            return Convert.ToBase64String(SecurityUtils.HmacSha1(Encoding.UTF8.GetBytes(key), Encoding.UTF8.GetBytes(baseString)));
        }
